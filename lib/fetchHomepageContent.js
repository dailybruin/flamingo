...
function filterEmbeddedData(item) {
  ...
  if (Array.isArray(filtered_embedded["wp:featuredmedia"])) {
    filtered_embedded["wp:featuredmedia"] = filtered_embedded[
      ...
      return {
        // Replace undefined with null explicitly
...
export async function fetchHomePageContent() {
  try {
    ...
    const fetchPromises = [
      fetchWithTimeout(
        `${Config.apiUrl}/wp-json/wp/v2/posts?_embed&per_page=1&tags=${TAG_IDS.aTAGID}&${Config.articleCardFields}`
      ),
      fetchWithTimeout(
        `${Config.apiUrl}/wp-json/wp/v2/posts?_embed&per_page=1&tags=${TAG_IDS.bTAGID}&${Config.articleCardFields}`
      ),
      fetchWithTimeout(
        `${Config.apiUrl}/wp-json/wp/v2/posts?_embed&per_page=1&tags=${TAG_IDS.c1TAGID}&${Config.articleCardFields}`
      ),
      fetchWithTimeout(
        `${Config.apiUrl}/wp-json/wp/v2/posts?_embed&per_page=1&tags=${TAG_IDS.c2TAGID}&${Config.articleCardFields}`
      ),
      fetchWithTimeout(
        `${Config.apiUrl}/wp-json/wp/v2/posts?_embed&per_page=1&tags=${TAG_IDS.d1TAGID}&${Config.articleCardFields}`
      ),
      fetchWithTimeout(
        `${Config.apiUrl}/wp-json/wp/v2/posts?_embed&per_page=1&tags=${TAG_IDS.d2TAGID}&${Config.articleCardFields}`
      ),
      fetchWithTimeout(
        `${Config.apiUrl}/wp-json/wp/v2/posts?_embed&per_page=3&tags=${TAG_IDS.gTAGID}&${Config.articleCardFields}`
      ),
      fetchWithTimeout(
        `${Config.apiUrl}/wp-json/wp/v2/posts?_embed&per_page=6&tags=${TAG_IDS.m1TAGID}&${Config.articleCardFields}`
      ),
      fetchWithTimeout(
        `${Config.apiUrl}/wp-json/wp/v2/posts?_embed&per_page=1&tags=${TAG_IDS.f1TAGID}&${Config.articleCardFields}`
      ),
      fetchWithTimeout(
        `${Config.apiUrl}/wp-json/wp/v2/posts?_embed&per_page=1&tags=${TAG_IDS.f2TAGID}&${Config.articleCardFields}`
      ),
      fetchWithTimeout(
        `${Config.apiUrl}/wp-json/wp/v2/posts?_embed&per_page=3&tags=${TAG_IDS.iTAGID}&${Config.articleCardFields}`
      ),
      fetchWithTimeout(
        `${Config.apiUrl}/wp-json/wp/v2/posts?_embed&per_page=3&tags=${TAG_IDS.jTAGID}&${Config.articleCardFields}`
      ),
      fetchWithTimeout(
        `${Config.apiUrl}/wp-json/wp/v2/posts?_embed&per_page=3&tags=${TAG_IDS.kTAGID}&${Config.articleCardFields}`
      ),
      fetchWithTimeout(
        `${Config.apiUrl}/wp-json/wp/v2/posts?_embed&per_page=3&tags=${TAG_IDS.lTAGID}&${Config.articleCardFields}`
      ),
      fetchWithTimeout(
        `${Config.apiUrl}/wp-json/wp/v2/posts?_embed&per_page=3&tags=${TAG_IDS.hTAGID}&${Config.articleCardFields}`
      ),
      fetchWithTimeout(
    ...
    console.error("fetchHomePageContent failed:", error);
    return {
      posts: {
        aStory: [],
        bStory: [],
