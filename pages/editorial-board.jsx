...
/**
 * Editorial Board page component
 * Fetches the editorial board information from WordPress by slug
 */
function Page({ page }) {
...
Page.getInitialProps = async () => {
  const pageRes = await fetch(
    `${Config.apiUrl}/wp-json/wp/v2/pages?slug=editorial-board&_embed`
  );
