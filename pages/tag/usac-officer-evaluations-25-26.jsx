...
import USACOfficerEvaluations2526Layout from "../../layouts/USACOfficerEvaluations2526/index.jsx";

class USACOfficerEvaluations2526 extends React.Component {
  static async getInitialProps() {
    const slug = "USAC-Officer-Evaluations-25-26";
      ...
      <>
        <Head>
          ...
          <meta
            ...
            content="The Daily Bruin editorial board evaluates the Undergraduate Students Association Council and their work for the 2025-2026 academic year."
          />
          <meta
            property="og:url"
            content="https://dailybruin.com/tag/usac-officer-evaluations-25-26"
          />
        ...
        <div>
          <USACOfficerEvaluations2526Layout
...
export default PageWrapper(USACOfficerEvaluations2526);
