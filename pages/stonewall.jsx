    ...
    <>
      ...
      >
        <div id="stonewall-wrap">
          ...
          <div id="blurb">
            <p>
              For <span>{new Date().getFullYear() - 1920}</span> years, the
              Daily Bruin has strived to hold UCLA accountable to the community
              it serves. We take that responsibility seriously. And when the
              Bruin is unjustly thwarted in its efforts to inform students, we
              believe you have a right to know. Each time our reporters are
          ...
          <ul id="stonewall" className="accordion" data-accordion>
            {stones &&
              stones.map((data, i) => {
                return (
                  <li className="accordion-navigation stone s" key={i}>
