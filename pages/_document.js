    ...
    return (
      <Html>
        <Head>
          ...
          {/* Google Fonts */}
          <link
            href="https://fonts.googleapis.com/css2?family=Bungee+Outline&family=Playfair+Display:ital,wght@0,550;0,700;1,550;1,700&family=Roboto:ital,wght@0,300;0,400;0,700;1,300;1,400;1,700&family=Source+Sans+Pro:wght@400;700&display=swap&family=DM+Serif+Text:ital@0;1&display=swap"
            rel="stylesheet"
          />
