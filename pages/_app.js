...
class MyApp extends App {
  ...
  render() {
    ...
    return (
      <>
        {/* Google Analytics - loaded with afterInteractive to not block page load */}
        <Script
        ...
        {/* Chartbeat - loaded with afterInteractive */}
        <Script id="chartbeat-config" strategy="afterInteractive">
          {`
